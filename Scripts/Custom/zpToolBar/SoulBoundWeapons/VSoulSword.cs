...
namespace Server.Items
{
    ...
    public class SoulVikingSword : VikingSword
    {
        private int exp = 0;
        ...
        public SoulVikingSword()
        {
            ...
            {
                case 0: EngravedText = "重剑无锋！"; break;
                case 1: EngravedText = "大巧不工！"; break;
                case 2: EngravedText = "力量觉醒！"; break;
            }
            ...
            if (exp < UnbindingDeed.ExSet)
            {
                ...
                if (exp >= UnbindingDeed.ExSet && level < 30)
                {
                    ...
                    if (level >= 5)
                    {
                        ...
                        if (level >= 10)
                        {
                            WeaponAttributes.SplinteringWeapon = (level - 9) * 2;
        ...
        #endregion menu
        public SoulVikingSword(Serial serial) : base(serial)
        {
        }
