...
namespace Server.Items
{
    ...
    public class Vtessen : Tessen
    {
        ...
        public Vtessen()
        {
            ...
            {
                case 0: EngravedText = "一股寒意！"; break;
                case 1: EngravedText = "羽扇纶巾谈笑间"; break;
                case 2: EngravedText = "樯榆灰飞烟灭"; break;
            }
            Hue = Utility.RandomMinMax(1458,1463);
            bond = 0;
        ...
        public void ApplyGain()
        {
            if (exp < UnbindingDeed.ExSet)
            {
                ...
                if (exp >= UnbindingDeed.ExSet && level < 30)
                {
                    ...
                    if (level >= 5)
                    {
                        WeaponAttributes.HitHarm = level * 3 + 10;
        ...
        public Vtessen(Serial serial) : base(serial) { }
