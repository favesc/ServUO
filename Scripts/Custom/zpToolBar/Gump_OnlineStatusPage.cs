...
namespace Server.Gumps
{
    public class StatusGump : Gump
   {
      ...
      {
         CommandSystem.Register( "SStat", AccessLevel.Counselor, new CommandEventHandler( Status_OnCommand ) );
         CommandSystem.Register( "ServerStatus", AccessLevel.Counselor, new CommandEventHandler( Status_OnCommand ) );
      }
