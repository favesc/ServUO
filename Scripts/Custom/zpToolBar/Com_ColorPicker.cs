...
namespace Scripts.ColorPicker
{
    public static class ColorPicker
    {
        ...
        {
            CommandSystem.Register("ColorPicker", AccessLevel.Player, new CommandEventHandler(ColorPicker_OnCommand));
        }
        ...
        {
            e.Mobile.CloseGump(typeof(ColorPickerGump));
        ...
        public class ColorPickerGump : Gump
        {
            ...
            public ColorPickerGump(Mobile m) : this(m, delegate (ColorPickerGump cp, Mobile mob, int h) { mob.Target = new ColorTarget(cp, h); }, true, DEFAULT_FIRST, DEFAULT_LAST)
            { }
